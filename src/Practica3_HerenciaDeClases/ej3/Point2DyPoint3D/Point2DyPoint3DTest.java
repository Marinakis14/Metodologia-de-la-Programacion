...
public class Point2DyPoint3DTest {
    public static void main(String[] args) {

        // Verificacion de la clase Point2D
        Point2D p2 = new Point2D(1.1f, 2.2f);
        System.out.println("Objeto Point2D: " + p2.toString());
        ...
        System.out.println("Objeto Point3D: " + p3.toString());
        ...
        System.out.println("Constructor sin parametros: " + puntoVacio.toString());
    }
}