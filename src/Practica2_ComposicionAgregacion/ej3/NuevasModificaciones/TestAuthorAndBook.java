...
public class TestAuthorAndBook {
    ...
    public static void main(String[] args) {
        ...
        b1.setQty(99);
        System.out.println(b1);
        System.out.println("isbn is: " + b1.getIsbn()); // En la salida esperada de la practica hay un error porque pone que la salida deberia ser "isbn is: Java for dummies" pero en realidad es "isbn is: 12345"
